...
#define TEXTVIEW_LENGTH 250
#define TEXTVIEW_LENGTH1 100
#define TEXT_LENGTH 30
#define TEXT_TYPE 1
#define IMAGE_TYPE 2
#define RECIPE_TYPE 3
#define TEXT_TYPE_STRING @"1"
#define IMAGE_TYPE_STRING @"2"
#define RECIPE_TYPE_STRING @"3"
#define loadQueue dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0)
#define S3URL @"https://s3-us-west-2.amazonaws.com/jaycolumbia12345/"
