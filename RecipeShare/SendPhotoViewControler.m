...
#import "SendPhotoViewControler.h"
...
@interface SendPhotoViewControler ()
...
@implementation SendPhotoViewControler
...
#pragma mark send text, send to oneself and other followers in two steps
...
- (void) imagePickerController: (UIImagePickerController *) picker didFinishPickingMediaWithInfo: (NSDictionary *) info {
    ...
    float newHeight = self.imageLeft.image.size.height;
